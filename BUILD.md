...
```bash
# Linux AMD64
zip dist/mariadb-backup-tool-1.0.3-linux-amd64.zip build/mariadb-backup-tool-linux-amd64

# Linux ARM64
zip dist/mariadb-backup-tool-1.0.3-linux-arm64.zip build/mariadb-backup-tool-linux-arm64

# macOS AMD64
zip dist/mariadb-backup-tool-1.0.3-darwin-amd64.zip build/mariadb-backup-tool-darwin-amd64

# macOS ARM64
zip dist/mariadb-backup-tool-1.0.3-darwin-arm64.zip build/mariadb-backup-tool-darwin-arm64

# Windows AMD64
zip dist/mariadb-backup-tool-1.0.3-windows-amd64.zip build/mariadb-backup-tool-windows-amd64.exe

# Windows ARM64
zip dist/mariadb-backup-tool-1.0.3-windows-arm64.zip build/mariadb-backup-tool-windows-arm64.exe
```
