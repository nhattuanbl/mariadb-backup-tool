...
sudo wget https://github.com/nhattuanbl/mariadb-backup-tool/releases/latest/download/mariadb-backup-tool-1.0.0-linux-amd64.zip
sudo unzip mariadb-backup-tool-1.0.0-linux-amd64.zip
...
- **Output**: `MariaDB Backup Tool v1.0.0`
